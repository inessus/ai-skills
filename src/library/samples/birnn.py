...
from library.vision.modules.basicmodels import BiRNN
...
def configure_net(input_size, hidden_size, num_layers, output_size, sequence_len):
    net_args = {
...
def main(args):
    ...
    net, net_args = configure_net(args.input_size, args.hidden_size, args.num_layers, args.output_size, args.sequence_len)
...
if __name__ == '__main__':
    ...
    # model options
    parser.add_argument('--input_size', type=int, action='store', default=28, help='input_size')
    parser.add_argument('--hidden_size', type=int, action='store', default=128, help='hidden_size')
    parser.add_argument('--output_size', type=int, action='store', default=10, help='output_size')
    parser.add_argument('--num_layers', type=int, action='store', default=2, help='num_layers')
    parser.add_argument('--sequence_len', type=int, action='store', default=28, help='sequence_len')
