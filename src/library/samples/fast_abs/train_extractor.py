...
# python train_extractor.py --path=/media/webdev/store/competition/bytecup2018/data/ffext
# --w2v=/media/webdev/store/competition/bytecup2018/data/word2vec/word2vec.128d.1747k.bin
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='training of the feed-forward extractor (ff-ext, ML)')
    parser.add_argument('--path', required=True, help='root of the model')

    # model options
    parser.add_argument('--net-type', action='store', default='ff', help='model type of the extractor (ff/rnn)')
